...
<div class="container">
    ...
    <td height="57" ><label>*عنوان الشقة</label>
<div class="container">
  ...
  <tr>
    <td height="57" ><label>*عنوان الشقة على الخريطة</label>
...
<div class="container">
     ...
     <select  name="frth" required style="font-size:20px; text-align:center; font-weight:bold;font-style:inherit;" >
