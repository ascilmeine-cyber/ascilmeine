...
$adress=$_POST['adress'];
	...
	$active_code1 =rand(1,999999);

$active_code =rand(1,999999).$active_code1;


 $targetfolder = "up_map/".$active_code;
...
if(move_uploaded_file($_FILES['file']['tmp_name'], $targetfolder))
 ...
 echo "Problem uploading file";
	...
	// أمر الحفظ الآمن
   $stmt = $conn->prepare("INSERT INTO  index_gps (	citee, adress, map_img) VALUES (?, ?, ?)");
  $stmt->bind_param("sss", $citee, $adress, $targetfolder);
