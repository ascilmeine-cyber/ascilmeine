...
$citee=$_POST['citee'];
$adress=$_POST['adress'];
$type_mabne=$_POST['type_mabne'];
$type_sal=$_POST['type_sal'];
$tgset_frst=$_POST['tgset_frst'];

$tgset_evry_yer_mon=$_POST['tgset_evry_yer_mon'];
$sal_tgset=$_POST['sal_tgset'];
$mabne_mater=$_POST['mabne_mater'];
$mabne_fot=$_POST['mabne_fot'];

$mabne_der=$_POST['mabne_der'];
$mabne_ads=$_POST['mabne_ads'];

$mfrosha=$_POST['mfrosha'];
$type_hall=$_POST['type_hall'];
$rom_mabne=$_POST['rom_mabne'];
$batherm_mabne=$_POST['batherm_mabne'];
$yre_mabne=$_POST['yre_mabne'];

$type_tgeri_skne=$_POST['type_tgeri_skne'];
$numbur_floors=$_POST['numbur_floors'];
$numbur_unts=$_POST['numbur_unts'];


$sal = str_replace( ',', '', $_POST['sal']); // إزالة الفواصل
$sall = (float)$sal;

$mabne_ster = isset($_POST['mabne_ster'])
        ? implode(" , ", $_POST['mabne_ster'])
        : ',';
  
 $stmt = $conn->prepare("INSERT INTO mabne ( citee, adress, type_mabne, sal, type_sal, tgset_frst, tgset_evry_yer_mon, sal_tgset, mabne_mater, mabne_fot, mabne_der, mabne_ads, img1, img2, img3, img4, img5, img6, img7, img8, mabne_ster, map_mabne, mfrosha, type_hall, rom_mabne, batherm_mabne, yre_mabne, type_tgeri_skne, numbur_floors, numbur_unts) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
  $stmt->bind_param("ssssssssssssssssssssssssssssss", $citee, $adress, $type_mabne, $sall, $type_sal, $tgset_frst, $tgset_evry_yer_mon, $sal_tgset, $mabne_mater, $mabne_fot, $mabne_der, $mabne_ads, $m1, $m2, $m3, $m4, $m5, $m6, $m7, $m8, $mabne_ster, $mmm, $mfrosha, $type_hall, $rom_mabne, $batherm_mabne, $yre_mabne, $type_tgeri_skne, $numbur_floors, $numbur_unts );
