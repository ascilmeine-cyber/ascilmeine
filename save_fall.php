...
$citee=$_POST['citee'];
$adress=$_POST['adress'];
$type_feall=$_POST['type_feall'];
$type_sal=$_POST['type_sal'];
$tgset_frst=$_POST['tgset_frst'];

$tgset_evry_yer_mon=$_POST['tgset_evry_yer_mon'];
$sal_tgset=$_POST['sal_tgset'];
$feall_mater=$_POST['feall_mater'];
$feall_fot=$_POST['feall_fot'];

$feall_der=$_POST['feall_der'];
$feall_ads=$_POST['feall_ads'];

$mfrosha=$_POST['mfrosha'];
$type_hall=$_POST['type_hall'];
$rom_feall=$_POST['rom_feall'];
$batherm_feall=$_POST['batherm_feall'];
$yre_feal=$_POST['yre_feal'];


$sal = str_replace( ',', '', $_POST['sal']); // إزالة الفواصل
$sall = (float)$sal;

$feall_ster = isset($_POST['feall_ster'])
        ? implode(" , ", $_POST['feall_ster'])
        : ',';
  
 $stmt = $conn->prepare("INSERT INTO feall ( citee, adress, type_feall, sal, type_sal, tgset_frst, tgset_evry_yer_mon, sal_tgset, feall_mater, feall_fot, feall_der, feall_ads, img1, img2, img3, img4, img5, img6, img7, img8, feall_ster, map_feall, mfrosha, type_hall, rom_feall, batherm_feall, yre_feal) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
  $stmt->bind_param("sssssssssssssssssssssssssss", $citee, $adress, $type_feall, $sall, $type_sal, $tgset_frst, $tgset_evry_yer_mon, $sal_tgset, $feall_mater, $feall_fot, $feall_der, $feall_ads, $m1, $m2, $m3, $m4, $m5, $m6, $m7, $m8, $feall_ster, $mmm, $mfrosha, $type_hall, $rom_feall, $batherm_feall, $yre_feal);
   //  citee, adress, type_feall, sal, type_sal, tgset_frst, tgset_evry_yer_mon, sal_tgset, feall_mater, feall_fot, feall_der, feall_ads, img1, img2, img3, img4, img5, img6, img7, img8, feall_ster map_feall, mfrosha, type_hall, rom_feall, batherm_feall, yre_feal
