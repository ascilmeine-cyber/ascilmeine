...
$land_mater=$_POST['land_mater'];

$land_fot=$_POST['land_fot'];
$land_der=$_POST['land_der'];
$land_ads=$_POST['land_ads'];
  ...
  $stmt = $conn->prepare("INSERT INTO  land (citee, adress, type_land, sal, type_sal, tgset_frst, tgset_evry_yer_mon, sal_tgset, land_mater, land_fot, land_der, land_ads, img1, img2, img3, img4, img5, img6, img7, img8, map) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
  $stmt->bind_param("sssdsssssssssssssssss", $citee, $adress, $type_land, $sal, $type_sal, $tgset_frst, $tgset_evry_yer_mon, $sal_tgset, $land_mater, $land_fot, $land_der, $land_ads, $m1, $m2, $m3, $m4, $m5, $m6, $m7, $m8, $mmm);
