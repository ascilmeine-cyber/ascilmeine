...
<table width="100%" height="35" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <p><img src="images/man.png" width="290" height="121" /></p></td>
      ...
      <form enctype="multipart/form-data"  method="post" action="save_mabne.php">
<table width="281" height="601" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td width="281" height="40" bgcolor="#38AEDD" ><div class="content">
      ...
      <h2><a href="birds.htm" align="center"><img src="images/inpt/set/5.png" alt="" width="213" height="57"background=""></a></h2>
    </div></td>
  </tr>
  <tr>
...
<div class="container">
    ...
    <td height="57" ><label>*عنوان البناية</label>
<div class="container">
  ...
  <tr>
    <td height="57" ><label>*عنوان البناية على الخريطة</label>
...
<div class="container">
     ...
     <select  name="type_mabne" required  style="font-size:20px; text-align:center; font-weight:bold;font-style:inherit; " >
      <option>---اختار نوع عرض البناية---</option>
      <option value="للبيع" >البناية للبيع</option>
      <option value="للإيجار">البناية للإيجار</option>
  ...
  <tr>
    <td height="57" ><label>*عدد الطوابق   </label>
<div class="container">

  
     <select  name="numbur_floors" required  style="font-size:20px; text-align:center; font-weight:bold;font-style:inherit; " >
      <option>---عدد الطوابق---</option>
    <?php
  for ($i = 1; $i <= 100; $i++) {
  ...
  <tr>
    <td height="57" ><label>*عدد الوحدات السكنية   </label>
<div class="container">

  
     <select   name="numbur_unts" required  style="font-size:20px; text-align:center; font-weight:bold;font-style:inherit; " >
      <option>---عدد الوحدات---</option>
  ...
  <tr>
    <td height="57" ><label>*نوع البناية</label>
<div class="container">

  
     <select  name="type_tgeri_skne" required style="font-size:20px; text-align:center; font-weight:bold;font-style:inherit;" >
      <option>- أختار نوع البناية -</option>
      <option value="سكني" >مبنىا سكني</option>
      <option value="تجاري">مبنىا تجاري</option>
...
<div class="container">
  ...
  <tr>
    <td height="57" >  <label>*النص الإعلاني للبناية</label>
<div class="container">

  
     <textarea name="mabne_ads"  type="text" cols="25" rows="3" class="boox" placeholder="اكتب النص هنا" onKeyDown="preventNumberInput(event)" aria-label="Transcription" style="font-size:20px; text-align:center; font-weight:bold;font-style:inherit;"></textarea>
  
</div></td>
  </tr>
  <tr>
    <td height="57" ><label>*سعر البناية </label>
<div class="container">
...
document.getElementById("number").addEventListener("input", function() {
  ...
  <tr>
    ...
    <select  name="rom_mabne" required style="font-size:20px; text-align:center; font-weight:bold;font-style:inherit;"  >
  ...
  <tr>
    <td height="18" ><label><br>
      *عدد الحمامات </label></td>
  </tr>
  <tr>
    <td height="18" ><div class="container">
    
    
    <select  name="batherm_mabne" required style="font-size:20px; text-align:center; font-weight:bold;font-style:inherit;"  >
      <option>-ادخل عدد الحمامات-</option>
      <option value="1" >1</option>
      <option value="2">2</option>
    <option value="3" >3</option>
      <option value="4">4</option>
  ...
  <tr>
    ...
    <select name="yre_mabne" required style="font-size:20px; text-align:center; font-weight:bold;font-style:inherit;">
...
function toggleTaqsit(){
  ...
  <tr>
    <td height="18" ><label>*مساحة البناية بالقدم </label></td>
  </tr>
  <tr>
    <td height="18" ><div class="container">
   
    <input type="number" step="any" id="feet" name="mabne_fot"
           placeholder="فوت" oninput="fromFeet()" style="font-size:20px; text-align:center; font-weight:bold;font-style:inherit;">
    </div></td>
  </tr>
  <tr>
    <td height="18" ><label>*مساحة البناية بالمتر  </label></td>
  </tr>
  <tr>
    <td height="18" ><div class="container">
      <input type="number" step="any" id="meter" name="mabne_mater"
...
<label><input type="checkbox" name="mabne_ster[]" value="مصعد"> مصعد</label><br>
<label><input type="checkbox" name="mabne_ster[]" value="موقف سيارات"> موقف سيارات</label><br>
<label><input type="checkbox" name="mabne_ster[]" value="مكيف"> مكيف</label><br>
<label><input type="checkbox" name="mabne_ster[]" value="مفروشة"> مفروشة</label><br>
<label><input type="checkbox" name="mabne_ster[]" value="حراسة"> حراسة</label><br>

<script>
const checkAll = document.getElementById('checkAll');
const checkboxes = document.querySelectorAll('input[name="mabne_ster[]"]');
...
checkboxes.forEach(cb => {
  ...
  <tr>
    <td height="18" ><div class="container">
      <textarea name="mabne_der"  type="text" cols="25" rows="3" class="boox" placeholder="اكتب النص هنا" onKeyDown="preventNumberInput(event)" aria-label="Transcription" style="font-size:20px; text-align:center; font-weight:bold;font-style:inherit;"></textarea>    
</div>
  ...
  <tr>
    <td height="18" ><label>*إرفاق صورة رئسيه البناية </label></td>
  </tr>
  <tr>
    <td height="18" ><div class="container">
