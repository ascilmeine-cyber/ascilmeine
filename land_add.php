...
<table width="100%" height="35" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <p><img src="images/man.png" width="290" height="121" /></p></td>
      ...
      <form enctype="multipart/form-data"  method="post" action="save_land.php">
<table width="281" height="601" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td width="281" height="40" bgcolor="#38AEDD" ><div class="content">
      ...
      <h2><a href="birds.htm" align="center"><img src="images/inpt/set/1.png" alt="" width="211" height="57"background=""></a></h2>
    </div></td>
  </tr>
  <tr>
...
<div class="container">
    ...
    <td height="57" ><label>*عنوان الأرض</label>
<div class="container">
  ...
  <tr>
    <td height="57" ><label>*عنوان الأرض على الخريطة</label>
...
<div class="container">
     ...
     <select  name="type_land" required  style="font-size:20px; text-align:center; font-weight:bold;font-style:inherit; " >
      <option>---اختار نوع عرض الأرض---</option>
      <option value="ارض للبيع" >ارض للبيع</option>
      <option value="ارض للإيجار">ارض للإيجار</option>
  ...
  <tr>
    <td height="57" >  <label>*النص الإعلاني للأرض</label>
<div class="container">

  
     <textarea name="land_ads"  type="text" cols="25" rows="3" class="boox" placeholder="اكتب النص هنا" onKeyDown="preventNumberInput(event)" aria-label="Transcription" style="font-size:20px; text-align:center; font-weight:bold;font-style:inherit;"></textarea>
  
</div></td>
  </tr>
  <tr>
    <td height="57" ><label>*سعر الأرض </label>
<div class="container">
...
function toggleTaqsit(){
  ...
  <tr>
    <td height="18" ><label>*مساحة الأرض بالقدم </label></td>
  </tr>
  <tr>
    <td height="18" ><div class="container">
   
    <input type="number" step="any" id="feet" name="land_fot"
           placeholder="فوت" oninput="fromFeet()" style="font-size:20px; text-align:center; font-weight:bold;font-style:inherit;">
    </div></td>
  </tr>
  <tr>
    <td height="18" ><label>*مساحة الأرض بالمتر  </label></td>
  </tr>
  <tr>
    <td height="18" ><div class="container">
      <input type="number" step="any" id="meter" name="land_mater"
  ...
  <tr>
    <td height="18" ><div class="container">
      <textarea name="land_der"  type="text" cols="25" rows="3" class="boox" placeholder="اكتب النص هنا" onKeyDown="preventNumberInput(event)" aria-label="Transcription" style="font-size:20px; text-align:center; font-weight:bold;font-style:inherit;"></textarea>    
</div>
  ...
  <tr>
    <td height="18" ><label>*إرفاق صورة رئسيه للأرض </label></td>
  </tr>
  <tr>
    <td height="18" ><div class="container">
