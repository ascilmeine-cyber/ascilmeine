...
$type_commercial=$_POST['type_commercial'];

$type_veiw=$_POST['type_veiw'];

$ples_tbg=$_POST['ples_tbg'];
...
$commercial_mater=$_POST['commercial_mater'];

$commercial_fot=$_POST['commercial_fot'];

$commercial_der=$_POST['commercial_der'];

$commercial_ads=$_POST['commercial_ads'];
...
$commercial_ster = isset($_POST['commercial_ster'])
        ? implode(" , ", $_POST['commercial_ster'])
        : ',';
  
 $stmt = $conn->prepare("INSERT INTO commercial ( citee, adress, type_commercial, type_veiw, ples_tbg, sal, type_sal, tgset_frst, tgset_evry_yer_mon, sal_tgset, commercial_mater, commercial_fot, commercial_der, commercial_ads, img1,img2, img3, img4, img5, img6, img7, img8, commercial_ster, map_commercial, mfrosha, type_hall) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
  $stmt->bind_param("ssssssssssssssssssssssssss", $citee, $adress, $type_commercial, $type_veiw, $ples_tbg, $sal, $type_sal, $tgset_frst, $tgset_evry_yer_mon, $sal_tgset, $commercial_mater, $commercial_fot, $commercial_der, $commercial_ads, $m1, $m2, $m3, $m4, $m5, $m6, $m7, $m8, $commercial_ster, $mmm, $mfrosha, $type_hall );
