...
<table width="100%" height="35" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <p><img src="images/man.png" width="290" height="121" /></p></td>
      ...
      <form enctype="multipart/form-data"  method="post" action="save_mahlt.php">
<table width="281" height="601" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td width="281" height="40" bgcolor="#38AEDD" ><div class="content">
      ...
      <h2><a href="birds.htm" align="center"><img src="images/inpt/set/88.png" alt="" width="255" height="57"background=""></a></h2>
    </div></td>
  </tr>
  <tr>
...
<div class="container">
    ...
    <td height="57" ><label>*عنوان المحل</label>
<div class="container">
  ...
  <tr>
    <td height="57" ><label>*عنوان  المحل على الخريطة</label>
...
<div class="container">
     ...
     <select  name="type_veiw" required  style="font-size:20px; text-align:center; font-weight:bold;font-style:inherit; " >
      <option>---اختار نوع عرض المحل---</option>
...
function toggleTaqsit(){
  ...
  <tr>
    <td height="18" ><label>*مساحة  المحل بالقدم </label></td>
  </tr>
  <tr>
    <td height="18" ><div class="container">
  ...
  <tr>
    <td height="18" ><label>*مساحة المحل بالمتر  </label></td>
  </tr>
  <tr>
    <td height="18" ><div class="container">
...
checkboxes.forEach(cb => {
  ...
  <tr>
    <td height="18" ><label>*إرفاق صورة رئسيه  المحل </label></td>
  </tr>
  <tr>
    <td height="18" ><div class="container">
