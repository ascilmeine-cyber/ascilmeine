...
<table width="100%" height="35" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <p><img src="images/man.png" width="290" height="121" /></p></td>
      ...
      <form enctype="multipart/form-data"  method="post" action="save_commercial.php">
<table width="281" height="601" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td width="281" height="40" bgcolor="#38AEDD" ><div class="content">
      ...
      <h2><a href="birds.htm" align="center"><img src="images/inpt/set/6.png" alt="" width="255" height="57"background=""></a></h2>
    </div></td>
  </tr>
  <tr>
...
<div class="container">
    ...
    <td height="57" ><label>*عنوان المكتب \ المحل</label>
<div class="container">
  ...
  <tr>
    <td height="57" ><label>*عنوان المكتب \ المحل على الخريطة</label>
<div class="container"><input type="file" name="map" placeholder="اكتب النص هنا" onKeyDown="preventNumberInput(event)"></div></td>
  </tr>
  </tr>
  <tr>
    <td height="57" ><label>*نوع العقار التجاري  </label>
<div class="container">

  
     <select  name="type_commercial" required  style="font-size:20px; text-align:center; font-weight:bold;font-style:inherit; " >
      <option>------</option>
...
<div class="container">
     ...
     <select  name="type_veiw" required  style="font-size:20px; text-align:center; font-weight:bold;font-style:inherit; " >
      <option>---اختار نوع عرض المكتب \ المحل---</option>
...
<div class="container">
  ...
  <tr>
    <td height="57" >  <label>*النص الإعلاني للعقار المكتب \ المحل</label>
<div class="container">
  ...
  <tr>
    <td height="57" ><label>*سعر المكتب \ المحل </label>
<div class="container">
...
function toggleTaqsit(){
  ...
  <tr>
    <td height="18" ><label>*مساحة المكتب \ المحل بالقدم </label></td>
  </tr>
  <tr>
    <td height="18" ><div class="container">
  ...
  <tr>
    <td height="18" ><label>*مساحة المكتب \ المحل بالمتر  </label></td>
  </tr>
  <tr>
    <td height="18" ><div class="container">
...
checkboxes.forEach(cb => {
  ...
  <tr>
    <td height="18" ><label>*إرفاق صورة رئسيه المكتب \ المحل </label></td>
  </tr>
  <tr>
    <td height="18" ><div class="container">
