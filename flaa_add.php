...
<table width="100%" height="35" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <p><img src="images/man.png" width="290" height="121" /></p></td>
      ...
      <form enctype="multipart/form-data"  method="post" action="save_fall.php">
<table width="281" height="601" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td width="281" height="40" bgcolor="#38AEDD" ><div class="content">
      ...
      <h2><a href="birds.htm" align="center"><img src="images/inpt/set/2.png" alt="" width="213" height="57"background=""></a></h2>
    </div></td>
  </tr>
  <tr>
...
<div class="container">
    ...
    <td height="57" ><label>*عنوان الفلة</label>
<div class="container">
  ...
  <tr>
    <td height="57" ><label>*عنوان الفلة على الخريطة</label>
...
<div class="container">
     ...
     <select  name="type_feall" required  style="font-size:20px; text-align:center; font-weight:bold;font-style:inherit; " >
      <option>---اختار نوع عرض الفلة---</option>
      <option value="الفلة للبيع" >الفلة للبيع</option>
      <option value="الفلة للإيجار">الفلة للإيجار</option>
...
<div class="container">
  ...
  <tr>
    <td height="57" >  <label>*النص الإعلاني للفلة</label>
<div class="container">

  
     <textarea name="feall_ads"  type="text" cols="25" rows="3" class="boox" placeholder="اكتب النص هنا" onKeyDown="preventNumberInput(event)" aria-label="Transcription" style="font-size:20px; text-align:center; font-weight:bold;font-style:inherit;"></textarea>
  
</div></td>
  </tr>
  <tr>
    <td height="57" ><label>*سعر الفلة </label>
<div class="container">
...
document.getElementById("number").addEventListener("input", function() {
  ...
  <tr>
    ...
    <select  name="rom_feall" required style="font-size:20px; text-align:center; font-weight:bold;font-style:inherit;"  >
  ...
  <tr>
    ...
    <select  name="batherm_feall" required style="font-size:20px; text-align:center; font-weight:bold;font-style:inherit;"  >
  ...
  <tr>
    ...
    <select name="yre_feal" required style="font-size:20px; text-align:center; font-weight:bold;font-style:inherit;">
...
function toggleTaqsit(){
  ...
  <tr>
    <td height="18" ><label>*مساحة الفلة بالقدم </label></td>
  </tr>
  <tr>
    <td height="18" ><div class="container">
   
    <input type="number" step="any" id="feet" name="feall_fot"
           placeholder="فوت" oninput="fromFeet()" style="font-size:20px; text-align:center; font-weight:bold;font-style:inherit;">
    </div></td>
  </tr>
  <tr>
    <td height="18" ><label>*مساحة الفلة بالمتر  </label></td>
  </tr>
  <tr>
    <td height="18" ><div class="container">
      <input type="number" step="any" id="meter" name="feall_mater"
...
<label><input type="checkbox" name="feall_ster[]" value="مصعد"> مصعد</label><br>
<label><input type="checkbox" name="feall_ster[]" value="موقف سيارات"> موقف سيارات</label><br>
<label><input type="checkbox" name="feall_ster[]" value="مكيف"> مكيف</label><br>
<label><input type="checkbox" name="feall_ster[]" value="مفروشة"> مفروشة</label><br>
<label><input type="checkbox" name="feall_ster[]" value="حراسة"> حراسة</label><br>

<script>
const checkAll = document.getElementById('checkAll');
const checkboxes = document.querySelectorAll('input[name="feall_ster[]"]');
...
checkboxes.forEach(cb => {
  ...
  <tr>
    <td height="18" ><div class="container">
      <textarea name="feall_der"  type="text" cols="25" rows="3" class="boox" placeholder="اكتب النص هنا" onKeyDown="preventNumberInput(event)" aria-label="Transcription" style="font-size:20px; text-align:center; font-weight:bold;font-style:inherit;"></textarea>    
</div>
  ...
  <tr>
    <td height="18" ><label>*إرفاق صورة رئسيه الفلة </label></td>
  </tr>
  <tr>
    <td height="18" ><div class="container">
